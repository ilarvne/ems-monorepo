...
export default function SearchCommandPalette() {
  ...
  return (
    <>
      <button
        className="inline-flex h-9 xl:w-[21rem] xl:mr-[13rem] rounded-md border border-input bg-background px-3 py-2 text-foreground text-sm placeholder:text-muted-foreground/70 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
